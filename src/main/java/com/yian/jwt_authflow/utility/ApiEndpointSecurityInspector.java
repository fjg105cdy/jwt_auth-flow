...
import com.yian.jwt_authflow.config.OpenApiConfigurationProperties;
import com.yian.jwt_authflow.config.PublicEndpoint;
...
public class ApiEndpointSecurityInspector {
    ...
    public void init() {
        ...
        handlerMethods.forEach((requestInfo, handlerMethod) -> {
            ...
            final var openApiEnable = openApiConfigurationProperties.getOpenAPI().getEnabled();
